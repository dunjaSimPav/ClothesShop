    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ArticleGroupId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParentArticleGroupId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleGroupItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleGroupItems_ArticleGroups_ArticleGroupId",
                        column: x => x.ArticleGroupId,
                        principalTable: "ArticleGroups",
                        principalColumn: "ArticleGroupId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleGroupItems_Articles_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleGroupItems_ArticleGroupId",
                table: "ArticleGroupItems",
                column: "ArticleGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleGroupItems_ArticleId",
                table: "ArticleGroupItems",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleGroupItems_Id",
                table: "ArticleGroupItems",
                column: "Id");
